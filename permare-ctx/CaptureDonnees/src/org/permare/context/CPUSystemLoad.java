...
/**
 * Collects CPU system load. 
 * This value seems to be percentual of usage (user + system) observed by
 * the VM. 
 * <b>Note:</b> This value use to be 0 in its first lecture (or at begining
