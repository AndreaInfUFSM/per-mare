...
////            
    ...
    private void initNetwork(InetSocketAddress peer) {
        ...
        try {
            ...
            Logger.getLogger(DHTLauncher.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            DHTLauncher<String, Integer> job = new DHTLauncher<String, Integer>();
