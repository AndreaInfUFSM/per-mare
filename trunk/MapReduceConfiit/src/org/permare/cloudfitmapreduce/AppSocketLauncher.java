...
import obsolete.network.appsockets.AppSocketAdapter;
...
public class AppSocketLauncher<K, V> {
...
////    
    ...
    private void initNetwork(InetSocketAddress peer) {
        ...
        NetworkAdapterInterface P2P = new AppSocketAdapter(queue, peer,community);
        ...
        try {
            ...
            Logger.getLogger(AppSocketLauncher.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            AppSocketLauncher<String, Integer> job = new AppSocketLauncher<String, Integer>();
