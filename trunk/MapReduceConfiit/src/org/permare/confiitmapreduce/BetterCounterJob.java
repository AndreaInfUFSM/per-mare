...
public class BetterCounterJob<K, V> {
    ...
    private String runMapper(Community community) {
        ...
        try {
            ...
            Logger.getLogger(BetterCounterJob.class.getName()).log(Level.SEVERE, null, ex);
        }
        return mapper;
    ...
    public static void main(String[] args) {
        ...
        BetterCounterJob<String, Integer> job = new BetterCounterJob<String, Integer>();
        try {
            job.setOutputDirectory(args[1]);
            job.setMapper("org.permare.confiitmapreduce.BetterMapper");
            //job.setMapper("Mapper");
            job.setMapArguments(args);

            job.setReducer("org.permare.confiitmapreduce.BetterReducer");
