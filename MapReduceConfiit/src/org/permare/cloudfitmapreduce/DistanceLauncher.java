...
public class DistanceLauncher<K, V> {
...
//            params.addElement(this.getMapArguments());
            Object[] params = new Object[]
              { ((ApplicationInterface)this.getMapper()), this.getMapArguments()};
            System.out.println("Parameter ok");
            System.out.println(client.execute("Submitter.plug", params));
...
//                             
    ...
    public static void main(String[] args) {
        ...
        try {
            DistanceLauncher<String, Integer> job = new DistanceLauncher<String, Integer>();
